        ...
        <div class="main">
            ...
            <div class="body1">
                <div class="header11">
                    ...
                    <input style="margin-left: 15px" v-model="planName_search" placeholder="请输入方案名称查询" type="text">
                    <Search
                            style="margin-left: 15px"
                            placeholder="请输入公司信息查询"
                            v-model="companyData_search"
                    ...
                    <el-table
                        ...
                        <el-table-column
                            ...
                            <template slot-scope="scope">
                                <span  class="aBtn" @click="showDetail(scope)">
                                    详情
                                </span>
                            </template>
                        </el-table-column>
...
<script>
    export default {
        ...
        methods: {
            showDetail(scope){
                this.$router.push({ name: 'personal', params: {...scope.row}});
            },
...
//                var param={...obj_page,queryStr:(param_search?JSON.stringify(param_search):"")};
                Util.makeWaiting();
                this.$http.post(Constant.ctx+"/runResult/statisticsCompany.do",
                        param
                ).then(response => {
                    Util.removeWaiting();
